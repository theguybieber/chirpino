...
// buttons on pins 6 and 7; briefly connect to ground to "press"
static Button leftButton(6, "l", "(");  // l for left mapped to chained previous
static Button rightButton(7, "r", ")"); // r for right mapped to chained next
