...
struct AutoplayStructure { // 9 bytes
...
struct PlaylistStructure { // 244 bytes
...
// no Store instance is ever created; all methods are static methods and the
// struct members merely provide a template for the storage layout WITHIN THE EEPROM
struct Store {
